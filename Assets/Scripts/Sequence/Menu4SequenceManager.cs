...
public class Menu4SequenceManager : MonoBehaviour
{
    RectTransform rectTransform;
    static Menu4SequenceManager instance;
    ...
    #region Get / Set
    public static Menu4SequenceManager Instance
    {
        get
        {
            if (instance == null)
                instance = FindObjectOfType<Menu4SequenceManager>();
            if (instance == null)
                Debug.LogError("Menu4SequenceManager not found");
            return instance;
        }
    }
    #endregion
